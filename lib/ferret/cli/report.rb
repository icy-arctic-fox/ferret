...
module Ferret
  class CLI < Thor
    ...
    class Report < Thor
      ...
      option :workdir, type: :string, desc: 'Work directory', default: Dir.tmpdir, banner: 'DIRECTORY', aliases: [:w]
      ...
      def branchdiff(source_repo, source_branch, destination_repo, destination_branch)
        ...
        schemes    = (settings.references_for_repository(source_repo) + settings.references_for_repository(destination_repo)).uniq
